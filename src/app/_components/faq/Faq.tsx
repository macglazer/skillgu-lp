...
export const Faq = async () => {
  ...
  return (
    <section className="relative m-auto flex w-full max-w-3xl flex-col gap-10 px-5 pb-[66px] pt-[44px] lg:pb-[88px]">
      <a id="faq" className={styles.faq_anchor} />
      <div>
        ...
        <p className="m-auto max-w-2xl p-3 text-center text-[14px] font-medium leading-6 text-base600 lg:text-base lg:leading-7">
          ...
          z nami, aby uzyskać dodatkową pomoc.
        </p>
      </div>
      <Accordion data={faq} />
    </section>
